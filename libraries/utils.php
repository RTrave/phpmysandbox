...
class MySBUtil
{
    ...
    public static function strverif($str, $match_html = true)
    {
        if (
            ...
            return false;
        if (
            stristr($str, 'SELECT') or stristr($str, 'JOIN') or
     ...
     * @return array|null $aEmails[0] Tableau dédoublonné des e-mails
     */
 ...
 * @param   string  $log        log of the *_process* par loading
 */
function _incTOBS($name, $module = '', $log = true)
{
    return MySBUtil::loadTemplate($name, $module, $log);
}
/**
 ...
 * @param   string  $log        log of the *_process* par loading
 */
function _incIOBS($name, $module = '', $log = true)
{
    return MySBUtil::loadInclude($name, $module, $log);
}
